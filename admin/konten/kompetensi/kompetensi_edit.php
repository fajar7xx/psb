<?php  
$id = $_GET['id'];
$data = query("SELECT * FROM kompetensi WHERE id_kompetensi = '$id'");
?>
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form action="<?=base_url('admin/konten/kompetensi/proses.php');?>" method="post">
            <input type="hidden" name="id" value="<?=$data['id_kompetensi'];?>">
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="kompetensi">Kompetensi</label>
                <input type="text" name="kompetensi" id="kompetensi" class="form-control" placeholder="masukkan jurusan yang terbaru" value="<?=$data['bid_kompetensi'];?>">
              </div>
              <div class="form-group col-md-6">
              </div>
            </div>
