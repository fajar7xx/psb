<?php  
$id = $_GET['id'];
$data = query("SELECT * FROM mapel WHERE id_mapel = '$id'");
?>
          ...
          <form action="<?=base_url('admin/konten/mapel/proses.php');?>" method="post">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="text" name="mapel" id="mapel" class="form-control" placeholder="masukkan jurusan yang terbaru" value="<?=$data['mapel'];?>">
              </div>
              <div class="form-group col-md-6">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <select name="aktif" id="aktif" class="form-control">
                  ...
                  <option value="Y" <?=($data['aktif_mapel'] == 'Y' ? 'selected' : '');?>>Aktif</option>
                  <option value="N" <?=($data['aktif_mapel'] == 'N' ? 'selected' : '');?>>Nonaktif</option>
                </select>
              </div>
            </div>
            <div class="form-row">
