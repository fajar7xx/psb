    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Data Yang Sudah Upload Foto</h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
          	...
          	<table class="table table-bordered" id="psb">
                ...
                ?>
                  <tr>
                    ...
                    <td><?=$data['nm_siswa'];?></td>
                    <td>
                      <a href="media.php?page=detail-foto&id=<?=$data['no_reg'];?>" class="btn btn-success btn-sm">
