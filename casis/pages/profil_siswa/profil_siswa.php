    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
		...
		<div class="row mt-2">
			...
			<div class="col-md-12"><?=$data['nisn'];?></div>
		</div>
		<hr>
		<div class="row mt-2">
			<div class="col-md-4 font-weight-bold">Nama</div>
			<div class="col-md-12"><?=$data['nm_siswa'];?></div>
		</div>
		<hr>
		<div class="row mt-2">
			<div class="col-md-4 font-weight-bold">Asal Sekolah</div>
			<div class="col-md-12"><?=$data['asal_sekolah'];?></div>
		</div>
		<hr>
		<div class="row mt-2">
			<div class="col-md-4 font-weight-bold">Status verifikasi</div>
			<div class="col-md-12"><?=$data['status_verifikasi'];?></div>
		</div>
		<hr>
		<?php 
		if($data['status_verifikasi'] == "Belum" OR $data['status_verifikasi'] == "Batal"):
		?>
			<div class="float-right">
				<a href="media.php?page=data-profil&reg=<?=$data['no_reg'];?>" class="btn btn-success">Lengkapi Data Siswa</a>
			</div>
		<?php  
